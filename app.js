...
function init() {
    ...
    elements['fossil'] = { id: 'fossil', name: 'fossil', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" style="display:block;width:1.2em;height:1.2em;"><path fill="currentColor" d="M320 64C232.6 64 160 136.6 160 224C160 288.4 198.2 344.4 253.6 369.6L230.6 419.2C224.2 434.1 235.4 451.2 251.7 451.2H288L272 544C268.6 561.8 282.5 576 300.3 576H339.7C357.5 576 371.4 561.8 368 544L352 451.2H388.3C404.6 451.2 415.8 434.1 409.4 419.2L386.4 369.6C441.8 344.4 480 288.4 480 224C480 136.6 407.4 64 320 64zM260 256C241.2 256 226 240.8 226 222C226 203.2 241.2 188 260 188C278.8 188 294 203.2 294 222C294 240.8 278.8 256 260 256zM380 256C361.2 256 346 240.8 346 222C346 203.2 361.2 188 380 188C398.8 188 414 203.2 414 222C414 240.8 398.8 256 380 256zM286 320C286 301.2 301.2 286 320 286C338.8 286 354 301.2 354 320C354 338.8 338.8 354 320 354C301.2 354 286 338.8 286 320z"/></svg>', discovered: false };
    elements['helicopter'] = { id: 'helicopter', name: 'helicopter', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" style="display:block;width:1.2em;height:1.2em;"><path fill="currentColor" d="M320 32C337.7 32 352 46.3 352 64L352 96L512 96C529.7 96 544 110.3 544 128C544 145.7 529.7 160 512 160L352 160L352 224L448 224C465.7 224 480 238.3 480 256L480 352C480 369.7 465.7 384 448 384L192 384C174.3 384 160 369.7 160 352L160 256C160 238.3 174.3 224 192 224L288 224L288 160L128 160C110.3 160 96 145.7 96 128C96 110.3 110.3 96 128 96L288 96L288 64C288 46.3 302.3 32 320 32zM192 416C174.3 416 160 430.3 160 448L160 512C160 547.3 188.7 576 224 576L416 576C451.3 576 480 547.3 480 512L480 448C480 430.3 465.7 416 448 416L192 416z"/></svg>', discovered: false };
