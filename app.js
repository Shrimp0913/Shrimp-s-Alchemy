...
function init() {
    ...
    elements['petroleum'] = { id: 'petroleum', name: 'petroleum', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" style="display:block;width:1.2em;height:1.2em;"><path fill="currentColor" d="M192 64C192 50.7 202.7 40 216 40L424 40C437.3 40 448 50.7 448 64L448 128L512 128C529.7 128 544 142.3 544 160L544 544C544 561.7 529.7 576 512 576L128 576C110.3 576 96 561.7 96 544L96 160C96 142.3 110.3 128 128 128L192 128L192 64zM288 224C270.3 224 256 238.3 256 256L256 448C256 465.7 270.3 480 288 480H352C369.7 480 384 465.7 384 448L384 256C384 238.3 369.7 224 352 224H288z"/></svg>', discovered: false };
