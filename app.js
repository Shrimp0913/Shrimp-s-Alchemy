...
function init() {
    ...
    elements['sword'] = { id: 'sword', name: 'sword', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--! Font Awesome Pro 7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2026 Fonticons, Inc. --><path fill="currentColor" d="M489.8 102.4L70.8 521.4C58.3 533.9 58.3 554.2 70.8 566.7L73.5 569.4C86 581.9 106.3 581.9 118.8 569.4L288.2 400L318.3 430.1C337 448.8 367.4 448.8 386.2 430.1L534.6 281.6C584.1 232.1 584.1 151.9 534.6 102.4C522.2 90 502.2 90 489.8 102.4z"/></svg>', discovered: false };
