...
function init() {
    ...
    elements['ocean'] = { id: 'ocean', name: 'ocean', icon: '<div style="display:flex;gap:0;line-height:0.3;font-size:0.5em;margin-left:-2px;"><div style="display:flex;flex-direction:column;gap:0;"><i class="fas fa-water"></i><i class="fas fa-water"></i></div><div style="display:flex;flex-direction:column;gap:0;margin-left:-2px;"><i class="fas fa-water"></i><i class="fas fa-water"></i></div></div>', discovered: false };
